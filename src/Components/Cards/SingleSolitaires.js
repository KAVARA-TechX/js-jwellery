...
import productImg from '../../Images/Diamond.jpg';
            ...
            <div className="container mt-5 mb-5">
                    <div className="row">       
                        <div className="col-md-6" >
                            <img src={productImg} alt="Single Product" width="500" height="420"/>
                        </div>
                        <div className="col-md-6" >
                           <h5>Diamond Solitaire</h5>
                           <StarRating
                    rating={4.3}
                    starRatedColor = "red"
                    starDimension = "16px"
...
export default SingleSolitaires;