...
<Link to="" style={{marginLeft:"15%"}} className="active">Loose Diamond</Link>
  <a href="#home">Diamond Rings</a>
  <a href="#news">Choose Your Perfect Diamond Jewellery</a>
  <a href="#contact">Diamond Care</a>
</div>
<div class="main">
